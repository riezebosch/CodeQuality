...
namespace AgentStatusFunction.Tests
{
    public class ReimageAgentsFunctionTests
    {
        ...
        public async Task AgentStillReImagingShouldNotReImageAgain()
        {
            ...
            //Act
            await ReimageAgentsFunction.ReImageAgent(log.Object, agentInfo, mockHttp.ToHttpClient(), tokenProvider);
        ...
        public void GetAgentInfoFromNameShouldSplitNamesIntoRightValues()
        {
            ...
            var result = ReimageAgentsFunction.GetAgentInfoFromName(fixture.Create<AgentStatus>(),
